                    ...
                    for applianceNr in range(len(appliances)):
                        ...
                        if refIndex == 0:
                            ...
                            for applianceStateNr in range(appliances[applianceNr]):
                                try:
                                    if (applianceState[applianceNr]==applianceStateNr or previousState[applianceNr]==applianceStateNr) and not applianceState[applianceNr]==previousState[applianceNr]:
                                        applianceAccuracy[applianceNr][applianceStateNr][2]+=1
                                        if applianceStatesRef[refIndex][1][applianceNr]==applianceState[applianceNr] and not applianceStatesRef[refIndex-1][1][applianceNr] == applianceStatesRef[refIndex][1][applianceNr] :
                                            applianceAccuracy[applianceNr][applianceStateNr][0]+=1
                                    if (applianceStatesRef[refIndex][1][applianceNr]==applianceStateNr or applianceStatesRef[refIndex-1][1][applianceNr] ==applianceStateNr) and not applianceStatesRef[refIndex-1][1][applianceNr] == applianceStatesRef[refIndex][1][applianceNr]:
                                        applianceAccuracy[applianceNr][applianceStateNr][1]+=1
                                except IndexError:
                                    pass
