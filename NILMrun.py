...
class NILMrun:
  ...
  def select(Value=None):
    if self.step==1:
      ...
      print("3: Statistical Anomaly Detection using local average and combined* deviation")
      print("4: Statistical Anomaly Detection using local average and deviation or lower limit")
